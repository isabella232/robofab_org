...
.. function:: newGlyph(glyphName, clear=True)
...
.. function:: removeGlyph(glyphName)
...
.. function:: insertGlyph(aGlyph, name=None)
...
.. function:: compileGlyph(glyphName, baseName, accentNames, adjustWidth=False, preflight=False, printErrors=True)
...
.. function:: generateGlyph(glyphName, replace=True, preflight=False, printErrors=True)
...
.. function:: getReverseComponentMapping
...
.. function:: save(destDir=None, doProgress=False, saveNow=False)
...
.. function:: writeUFO(self, path=None, doProgress=False, glyphNameToFileNameFunc=None, doHints=False, doInfo=True, doKerning=True, doGroups=True, doLib=True, doFeatures=True, glyphs=None, formatVersion=2)
...
.. function:: appendHGuide()

Append a horizontal guide.

.. function:: appendVGuide()
...
.. function:: generate(outputType, path=None)
